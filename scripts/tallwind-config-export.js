...
const ThemeBreakpoints = () => {
  ...
  tailwindConfig.theme.screens = _.pickBy(
  ...
  const BreakpointsYmlPath = path.join(process.cwd(), "mytheme.breakpoints.yml");
...
const CssVariables = () => {
  ...
  fs.unlink(sassOutputPath, (err) => {
    ...
    fs.appendFileSync(
      sassOutputPath,
      "/** Automatically generated from tailwind.config.js — please do not edit. */"
    );
  });
