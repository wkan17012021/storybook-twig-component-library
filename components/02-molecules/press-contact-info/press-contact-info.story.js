...
export default {
  ...
  args: {
    ...
    email: linkTemplate({
      ...
      classes: ['u-inline', 'u-font-light', 'u-underline', 'u-decoration-solid', 'u-decoration-1', 'u-decoration-ochre', 'u-underline-offset-2'],
    ...
    telephone: linkTemplate({
      ...
      remove_classes: ['u-text-burnt-orange'],
      classes: ['u-font-light', 'u-underline', 'u-decoration-solid', 'u-decoration-1', 'u-decoration-ochre', 'u-underline-offset-2'],
    }),
  },
  argTypes: {
    title: {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A text box to display press contact details for the News single design.',
      },
    },
  },
};
