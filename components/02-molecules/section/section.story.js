...
export default {
  ...
  argTypes: {
    ...
    has_overlay: {
      description:
        "Set to true if the content has an overlay e.g. People profiles.",
      table: {
    ...
    cta_button: {
      description:
        "To display a CTA button at the bottom of the section specify a button object with `url`, `content`, and `new_window`.",
    },
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A section is a generic molecule that provides the foundations for the majority of organisms. By default, it is a `<section>` HTML element with `<header>` and `<footer>`.",
      },
    },
  },
};
